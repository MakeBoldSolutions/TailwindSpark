 ...
 * 
 * TypeScript types and Zod schemas for OpenWeatherMap API
 ...
 * Structure returned by OpenWeatherMap API (before transformation)
 */
...
export const WEATHER_API_CONFIG = {
  ...
  /** Default units (imperial for Fahrenheit/mph) */
  UNITS: 'imperial' as const,
  
  /** API key (should be in environment variables) */
  API_KEY_ENV: 'VITE_OPENWEATHERMAP_API_KEY',
