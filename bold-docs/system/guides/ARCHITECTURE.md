...
├── bold-docs/              # Bold workspace: backbone, genome, active system docs (this file), features
├── .archive/               # Committed, human-only history (harvested work products, old DevSpark artifacts)
├── .bold/                  # Bold tool install (disposable, manifest-owned) -- migrated from DevSpark 2026-07-09
