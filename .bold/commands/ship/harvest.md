...
Work products move wholesale to `.archive/` (root-level, not under `bold-docs/`). Append one entry to `.archive/index.md`: what was archived, when, and what (if anything) it promoted into `system/`.
