...
const CommitSizeSchema = z.object({
  sha: z.string(),
  date: z.string(),
  size: z.number(),
...
const CommitMetricsSchema = z.object({
  avg_size: z.number(),
  total_commits: z.number(),
  largest_commit: CommitSizeSchema,
  smallest_commit: CommitSizeSchema,
  commit_size_distribution: z.object({
    min: z.number(),
    q1: z.number(),
    median: z.number(),
    q3: z.number(),
...
const AlertCountsSchema = z.object({
  total_open: z.number(),
  critical: z.number(),
  high: z.number(),
  medium: z.number(),
 ...
 */
export const RawRepositorySchema = z.object({
  name: z.string(),
  ...
  commit_metrics: CommitMetricsSchema,
